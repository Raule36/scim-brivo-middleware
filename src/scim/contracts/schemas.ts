...
export const s_ServiceProviderConfigAuthenticationScheme = z.object({
  type: z.enum(['oauth', 'oauth2', 'oauthbearertoken', 'httpbasic', 'httpdigest']),
  name: z.string(),
  description: z.string(),
...
export const s_ServiceProviderConfig = z.object({
  schemas: z
    .array(z.enum(['urn:ietf:params:scim:schemas:core:2.0:ServiceProviderConfig']))
    .optional()
  ...
  meta: s_BaseMeta
    .merge(
      z.object({
        resourceType: z.enum(['ServiceProviderConfig']).optional().default('ServiceProviderConfig'),
      }),
    )
    .optional(),
});
...
export const s_Schemas = s_ListResponse.merge(z.object({ Resources: z.array(s_Schema) }));

export const s_User = s_CreateUser.merge(z.object({ id: z.string(), meta: s_UserResourceMeta }));

export const s_GroupsListing = s_ListResponse.merge(z.object({ Resources: z.array(s_Group) }));

export const s_UsersListing = s_ListResponse.merge(z.object({ Resources: z.array(s_User) }));
